...
class SponsorCreateAPIView(CreateAPIView):
    ...
    serializer_class = serializer.SponsorCreateSerializer
class SponsorListAPIView(ListAPIView):
    queryset = models.Sponsor.objects.all()
    serializer_class = serializer.SponsorDatailSerializer
...
class SponsorUpdateAPIView(UpdateAPIView):
    queryset = models.Sponsor.objects.all()
    serializer_class = serializer.SponsorUpdateSerializer
    lookup_field = "pk"
class StudentSponsorCreateAPIView(CreateAPIView):
    queryset = models.StudentSponsor
    serializer_class = serializer.SponsorStudentCreateSerializer
...
class DashboartStatisticAPIView(APIView):
...
class StudentCreateAPIView(CreateAPIView):
    queryset = models.Student.objects.all()
    serializer_class = serializer.StudentCreateSerializer


class StudentUpdateAPIView(UpdateAPIView):
    queryset = models.Student.objects.all()
    serializer_class = serializer.StudentUpdateSerializer
    lookup_field = "pk"
